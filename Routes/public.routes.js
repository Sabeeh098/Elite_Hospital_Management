...
public_routes.receptionistlogin = "/receptionlogin";
public_routes.doctorlogin = "/doctor-login";
// -- Product Router-- //
public_routes.product_list = "/product-list";
public_routes.patients_list = "/patients-list";
public_routes.patient_details = "/patient-details";

public_routes.add_pateints = "/add-patients";
public_routes.product_management = "/products";
public_routes.product_details = "/productDetails"

///////////Nurse
public_routes.addnurse = "/add-nurse";
public_routes.nurseslist = "/nurse-list";
public_routes.nurseHome = "/nurseHome"
public_routes.patientDetails = "/Nurse-view-patient"
public_routes.addNotesnurse = "/Nurse-Add-Notes"
public_routes.nurseListNotes = "/Nurse-List-Notes"
public_routes.showNoticenurse = "/Nurse-Notice"

// public_routes.editPatientsNurse = "/nurse-patient-edit"
///////////////Doctor
public_routes.adddoctor = "/add-doctor";
public_routes.doctorslist = "/doctor-list";
public_routes.updatePrescription = "/doctor-prescrition"
public_routes.editPatientPrep = "/doctor-prescription"
public_routes.docProManage = "/Doctor-Product-Mange"
public_routes.DocProDetails = "/Doctor-Product-Details"
public_routes.Docaddnotes = "/Doctor-add-notes"
public_routes.doctorListNotes = "/Doctot-List-Notes"
public_routes.showDocNotice = "/Doctor-Notice"

////////////Reception
public_routes.receptionHome = "/receptionHome"
public_routes.showDetails = "/Recep-View-Patient"
public_routes.addReception = "/add-reception"
public_routes.receptionList = "/Reception-list"
public_routes.addRecPatients = "/Receptionist-Add_Patient"
public_routes.ShowNotice = "/Reception-Show-Notice"
public_routes.addNotesRec = "/Reception-Add-Note" 
public_routes.listNotesRec = "/Reception-list-Notes"


///////////patient/////////
public_routes.editPatientsNurse = "/nurse-editPatient"
...
///Send Mail
public_routes.send_mail = "/send-mail";

public_routes.notes_add = "/add-notes";
public_routes.list_notes = "/notes-list";
public_routes.notice = "/notices";


public_routes.product_addProduct = "/add-product";

public_routes.product_addBarcode = "/add-barcode";

public_routes.list_barcode = "/list-barcode";
public_routes.barcode_details = "/barcode-details";
public_routes.scan_barcode = "/scan-barcode";
...
public_routes.expense_expenseList = "/bill-list";
public_routes.edit_bill = "/edit-bill";
public_routes.bill_details = "/bill-details";

public_routes.medicine_list = "/medicine-list";

public_routes.expense_addExpense = "/add-expense";
public_routes.add_medicine = "/add-medicine";
public_routes.edit_medicine = "/edit-medicine";
...
public_routes.doctorhome = "/doctorHome"
...
public_routes.elements_notification = "/notification";
